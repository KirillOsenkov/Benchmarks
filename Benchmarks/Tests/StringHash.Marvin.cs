...
// Contributed by Ben Adams: https://gist.github.com/benaadams/b50073a5733b92f668de39a520afec5d
...
namespace System
{
    internal static partial class Marvin
    {
        ...
        public static int ComputeHash32(string data)
            => ComputeHash32(MemoryMarshal.Cast<char, byte>(data.AsSpan()), DefaultSeed);

        /// <summary>
        /// Compute a Marvin hash and collapse it into a 32-bit hash.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int ComputeHash32(string data, ulong seed)
            => ComputeHash32(MemoryMarshal.Cast<char, byte>(data.AsSpan()), seed);
        ...
        public static int ComputeHash32(ReadOnlySpan<byte> data)
            => ComputeHash32(data, DefaultSeed);
        ...
        private static ulong DefaultSeed { get; } = GenerateSeed();
