...
namespace Tests
{
    ...
    public struct MurmurHash3_32 : IEquatable<MurmurHash3_32>
    {
        ...
        public static unsafe MurmurHash3_32 Create(string text)
        {
            var span = MemoryMarshal.Cast<char, byte>(text.AsSpan());
            fixed (byte* b = span)
            {
                return Create(key: b, len: (uint)span.Length);
            }
        }
        ...
        {
            if (obj is MurmurHash3_32 other)
            {
                return Equals(other);
            }
    ...
    public struct MurmurHash3 : IEquatable<MurmurHash3>
    {
        ...
        public static unsafe MurmurHash3 Create(string text)
        {
            var span = MemoryMarshal.Cast<char, byte>(text.AsSpan());
            fixed (byte* b = span)
            {
